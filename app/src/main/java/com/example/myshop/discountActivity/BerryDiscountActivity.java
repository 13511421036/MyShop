...
import com.example.myshop.activity.RegisterActivity;
...
public class BerryDiscountActivity extends AppCompatActivity {


    ActivityBerryDiscountBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityBerryDiscountBinding.inflate(getLayoutInflater());
        ...
        binding.berryCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                shoppingCartData.insertData("berry",49,1);
                Toast.makeText(BerryDiscountActivity.this,"加入购物车成功！",Toast.LENGTH_SHORT).show();
            }
        });
        binding.buyberrynow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            if(item.getItemId()==R.id.bottom_Market){
                Intent intent1 = new Intent(BerryDiscountActivity.this, MainActivity.class);
                ...
                Intent intent1 = new Intent(BerryDiscountActivity.this, ShoppingCartActivity.class);
                intent1.putExtra("USERNAME_KEY", username);
                startActivity(intent1);
                overridePendingTransition(0,0);
                finish();
                ...
                Intent intent1 = new Intent(BerryDiscountActivity.this, PersonalActivity.class);
                intent1.putExtra("USERNAME_KEY", username);
                startActivity(intent1);
                overridePendingTransition(0,0);
                finish();
